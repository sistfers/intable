...
<%
	...
	if (login == null || !(login.get("issonnim").equals("false"))) {
		...
		login.put("note", login.get("note").replace("<br>", "\r\n"));
	...
	<div id="container" class="container">
		...
		<main id="site_main" class="row container"> <header id="page_header"
			...
			<h1 class="col-md-7 col-md-offset-1">
				<strong style="color: black; font-size: 30px;">음식점 수정</strong>
			</h1>
		</header>
		<article id="page_article" class="row">
			<form name="storeForm" id="storeForm" action="../store/store_control.jsp"
				method="post" onsubmit="return store.update();" class="form-horizontal">
				<input type="hidden" name="action" value="update"><input
					type="hidden" name="sido" id="sido" value="${sessionScope.login.sido}"><input
					type="hidden" name="sigungu" id="sigungu"
				...
				<div class="form-group">
					...
					<div class="col-md-1">
						<select name="maxbooking" id="maxbooking" class="form-control"
							style="width: 100px;" tabindex="10" title="" required><option
					...
					<div class="col-md-1">
						<select name="open" id="open" class="form-control" style="width: 100px;"
							tabindex="11" title="" required><option
				...
				<div class="form-group">
					<div class="col-md-1 col-md-offset-2">
						<img src="${sessionScope.login.imageuri1}" width="100px" height="100px"
							class="img-thumbnail">
					</div>
					<div class="col-md-1">
						<img src="${sessionScope.login.imageuri2}" width="100px" height="100px"
							class="img-thumbnail">
					</div>
					<div class="col-md-1">
						<img src="${sessionScope.login.imageuri3}" width="100px" height="100px"
							class="img-thumbnail">
					</div>
					<div class="col-md-1">
						<img src="${sessionScope.login.imageuri4}" width="100px" height="100px"
							class="img-thumbnail">
					</div>
					<div class="col-md-1">
						<img src="${sessionScope.login.imageuri5}" width="100px" height="100px"
							class="img-thumbnail">
					</div>
					<div class="col-md-2 col-md-offset-2">
						<input type="button" name="uploadImage" id="uploadImage" value="사진 변경"
							class="btn btn-primary" tabindex="" placeholder="사진 변경" title="사진 변경"
				...
				<div class="form-group">
					<div class="col-md-5 col-md-offset-4">
						<input type="submit" id="store_form_submit" value="수정"
