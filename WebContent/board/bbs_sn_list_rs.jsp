...
<%			
	...
	if(wd != null) {
		...
		total_cnt = dao.do_words_pagi("son_help", wd);
	} else {
	...
	if(wd != null) {
		s = dao.do_words_result(pageNum, 10, wd, "sonnim", "son_help");
	} else {
			...
			<table class="table table-striped table-hover">
				...
				<%
					if (sesson.get("issonnim").equals("true")) {
						...
						%>
						<p align="right"><input type="button" value="상점 게시판" class="btn btn-default"
