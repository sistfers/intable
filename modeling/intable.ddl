ALTER TABLE BOOKING
	DROP
		CONSTRAINT FK_SONNIM_TO_BOOKING
		CASCADE;

ALTER TABLE BOOKING
	DROP
		CONSTRAINT FK_STORE_TO_BOOKING
		CASCADE;

ALTER TABLE HEART
	DROP
		CONSTRAINT FK_SONNIM_TO_HEART
		CASCADE;

ALTER TABLE HEART
	DROP
		CONSTRAINT FK_STORE_TO_HEART
		CASCADE;

ALTER TABLE SON_HELP
	DROP
		CONSTRAINT FK_SONNIM_TO_SON_HELP
		CASCADE;

ALTER TABLE SON_HELP
	DROP
		CONSTRAINT FK_SON_HELP_TO_SON_HELP
		CASCADE;

ALTER TABLE STORE_HELP
	DROP
		CONSTRAINT FK_STORE_HELP_TO_STORE_HELP
		CASCADE;

ALTER TABLE STORE_HELP
	DROP
		CONSTRAINT FK_STORE_TO_STORE_HELP
		CASCADE;

ALTER TABLE STORE_SON
	DROP
		CONSTRAINT FK_STORE_SON_TO_STORE_SON
		CASCADE;

ALTER TABLE STORE_SON
	DROP
		CONSTRAINT FK_SONNIM_TO_STORE_SON
		CASCADE;

ALTER TABLE STORE_SON
	DROP
		CONSTRAINT FK_STORE_TO_STORE_SON
		CASCADE;

ALTER TABLE REVIEW
	DROP
		CONSTRAINT FK_SONNIM_TO_REVIEW
		CASCADE;
...
DROP INDEX UIX_SONNIM;

DROP INDEX UIX_STORE;

DROP INDEX FK_SONNIM_TO_BOOKING;

DROP INDEX FK_STORE_TO_BOOKING;

DROP INDEX FK_SONNIM_TO_SON_HELP;

DROP INDEX FK_SON_HELP_TO_SON_HELP;

DROP INDEX FK_STORE_HELP_TO_STORE_HELP;

DROP INDEX FK_STORE_TO_STORE_HELP;

DROP INDEX FK_STORE_SON_TO_STORE_SON;

DROP INDEX FK_SONNIM_TO_STORE_SON;

DROP INDEX FK_STORE_TO_STORE_SON;

DROP INDEX FK_SONNIM_TO_REVIEW;

DROP INDEX FK_STORE_TO_REVIEW;

DROP INDEX PK_SONNIM;

DROP INDEX PK_STORE;

DROP INDEX PK_BOOKING;

DROP INDEX PK_HEART;

DROP INDEX PK_SON_HELP;

DROP INDEX PK_STORE_HELP;

DROP INDEX PK_STORE_SON;

DROP INDEX PK_REVIEW;

/* 손님 기본키 */
DROP TRIGGER TRG_SONNIM;

/* 음식점 기본키 */
DROP TRIGGER TRG_STORE;

/* 예약 기본키 */
DROP TRIGGER TRG_BOOKING;

/* 손님지원qna */
DROP TRIGGER TRG_SON_HELP;

/* 음식점지원qna */
DROP TRIGGER TRG_STORE_HELP;

/* 음식점손님qna 기본키 */
DROP TRIGGER TRG_STORE_SON;
...
/* 음식점지원qna */
DROP TABLE STORE_HELP 
	CASCADE CONSTRAINTS;

/* 음식점손님qna */
DROP TABLE STORE_SON 
	CASCADE CONSTRAINTS;
